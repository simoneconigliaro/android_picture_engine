...
- The sort icon will allowed the user to sort the list by most popular, latest and oldest.
- The search icon will direct the user to a new screen where the they will be able to make custom searches.
- The setting icon opens up a bottom sheet dialog icon where it will be possible to change the app theme and gets some info from the about section.
